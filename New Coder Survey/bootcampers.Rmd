...
```{r}
bootcampDegrees = as.data.frame(table(bootcampers$SchoolMajor))
bootcampDegrees = bootcampDegrees[bootcampDegrees$Freq != 0,]
bootcampDegrees = tail(bootcampDegrees[order(bootcampDegrees$Freq),], 10)
names(bootcampDegrees) = c("Major", "Freq")
kable(bootcampDegrees)
```
