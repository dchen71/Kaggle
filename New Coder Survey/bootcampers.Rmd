...
As can be seen in the graph, the best is Hack Reactor. Hack Reactor had about 95% of it's particpants with jobs after the program. The most attended one, General Assembly, had about 61%. The average percentage for job afterwards is `r mean(bootcamp_stats$Percent)`.
