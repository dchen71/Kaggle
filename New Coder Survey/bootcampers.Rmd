...
I'm interested in seeing who are the types of people who attend bootcamps, and the impact of programming bootcamps. 
...
Let's take a lot at some of the demographic data.
...
```{r}
table(bootcampers$BootcampName)
```
