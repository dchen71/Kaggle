...
The majority of people who attended bootcamps already had bachelor's degrees. Following themare those with some college credit and those with master's degrees.
...
As can be seen in the plot, more than half of those who had attended, ended up with full time job after bootcamp. 
...
ggplot(majors_hired, aes(x=Major, y=Freq, fill=Major)) + 
  geom_bar(stat="identity") +
  ggtitle("School Major of those with job after") +
  xlab("Degree") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
ggplot(majors_nothired, aes(x=Major, y=Freq, fill=Major)) + 
  geom_bar(stat="identity") +
  ggtitle("School Major of those without job after") +
  xlab("Degree") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
